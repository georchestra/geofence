...
//    private final static Logger LOGGER = LogManager.getLogger(BaseTest.class);
    protected static final Log LOGGER = LogFactory.getLog(BaseTest.class.getPackage().getName());
    @Rule
...
//        String startDir = System.getProperty("buildDirectory");
        String startDir = "/home/fgravin/dev/geofence/geofence/src/samples/csv2geofence/target/test";
